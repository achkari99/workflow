                ...
                <div className="space-y-3">
                  {sessions.map((item) => (
                    <button
                      ...
                      className={`w-full text-left border px-3 py-2 text-xs transition-colors ${selectedSessionId === item.id
                    ...
                    {searchResults && searchResults.length > 0 && (
                      <div className="mt-3 space-y-2">
                        {searchResults.map((candidate) => (
                          ...
                          >
                            <span>{candidate.username || candidate.email || candidate.firstName || candidate.id}</span>
                    ...
                    {canManageAssignments && (
                      <div className="space-y-3 border-t border-white/10 pt-4">
                        <input
                          ...
                          placeholder="Search username or email to assign..."
                            ...
                            {canManageAssignmentDelegates && selectedAssignment.allowDelegation && (
                              <div className="space-y-3">
                                <input
                                  ...
                                  placeholder="Search username or email to delegate..."
                                  className="w-full bg-black/40 border border-white/10 px-3 py-2 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-primary"
                                />
                    ...
                    {canManageLaneDelegates && laneOwnerId && (
                      <div className="space-y-3">
                        <input
                          ...
                          placeholder="Search username or email to allow..."
                          className="w-full bg-black/40 border border-white/10 px-3 py-2 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-primary"
                        />
